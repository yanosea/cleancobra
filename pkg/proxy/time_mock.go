...
func (m *MockTime) Now() TimeAlias {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Now")
	ret0, _ := ret[0].(TimeAlias)
	return ret0
}
...
func (m *MockTime) Parse(layout, value string) (TimeAlias, error) {
	m.ctrl.T.Helper()
...
func (m *MockTime) Since(t TimeAlias) Duration {
	m.ctrl.T.Helper()
