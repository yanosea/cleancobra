...
- [ ] 1. Set up project foundation and proxy layer
...
- [ ] 2. Implement domain layer with core business logic
...
- [ ] 3. Create configuration management system (app/config)
...
- [ ] 4. Implement JSON-based repository infrastructure
...
- [ ] 5. Build application layer use cases

- [ ] 5.1 Implement AddTodoUseCase
...
- [ ] 5.3 Implement ToggleTodoUseCase
...
- [ ] 5.4 Implement DeleteTodoUseCase
...
- [ ] 6. Create CLI presentation layer formatters

- [ ] 6.1 Implement JSON formatter
...
- [ ] 6.3 Implement plain text formatter
...
- [ ] 7. Build CLI presentation layer components

- [ ] 7.1 Implement TodoPresenter
...
- [ ] 7.7 Implement shell completion commands

- [ ] 7.7.1 Create completion parent command
...
- [ ] 7.7.2 Implement bash completion subcommand
...
- [ ] 7.7.3 Implement zsh completion subcommand
...
- [ ] 7.7.4 Implement fish completion subcommand
...
- [ ] 7.7.5 Implement powershell completion subcommand
...
- [ ] 8. Create dependency injection container (app/container)
...
- [ ] 9. Create composition root and CLI main
...
- [ ] 10. Implement TUI model layer (ELM Architecture)

- [ ] 10.1 Create TUI item model
...
- [ ] 11. Implement TUI update layer (ELM Architecture)

- [ ] 11.1 Create TUI item update logic
...
- [ ] 11.2 Create TUI handler update logic
...
- [ ] 12. Implement TUI view layer (ELM Architecture)

- [ ] 12.1 Create TUI item view components
...
- [ ] 13. Create TUI composition root and main
...
- [ ] 13.1 Refactor TUI to CLI-like structure
...
- [ ] 14. Add comprehensive test coverage and validation

- [ ] 14.1 Create tests for TUI input model
...
- [ ] 14.2 Create tests for TUI messages model
...
- [ ] 14.3 Create tests for TUI keyboard handler
...
- [ ] 14.4 Create tests for TUI operations handler
...
- [ ] 14.5 Create tests for TUI footer view
...
- [ ] 14.6 Create tests for TUI header view
...
- [ ] 14.7 Create tests for TUI list view
